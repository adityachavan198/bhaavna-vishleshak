...
def test_with_unigram_tf_dbn():
    ...
    return [mean(accuracies),mean(f_measures)]


def test_with_unigram_tfidf_dbn():
...
#     print(acc_tf_dbn,f_mes_tf_dbn,"\n",acc_tfidf_dbn,f_mes_tfidf_dbn)
